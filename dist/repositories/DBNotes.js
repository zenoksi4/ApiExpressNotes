...
exports.db = {
    notes: [
        ...
        { id: '4', title: 'note4', created: new Date().toLocaleDateString('uk'), category: 'Task', content: 'notes4' },
        { id: '5', title: 'note5', created: new Date().toLocaleDateString('uk'), category: 'Idea', content: 'notes5' },
    ],
};
